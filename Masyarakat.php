...
class Masyarakat extends CI_Controller {
    ...
    //jika variabrl session login_status== ok maka tampilkan aduan
    ...
    public function registrasi_user(){
        ...
        //jika form validation bermasalah maka di kembalikan ke metho registrasi dengan pesan error
...
public function login(){
    ...
    //jika form validation bermasalah maka dikembalikan ke metho dengan pesan error
    if($this->form_validation->run()==FALSE){
        $this->index();
    }else{
        $pass=md5($_POST['password']);
